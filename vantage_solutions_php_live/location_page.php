					 ...
					 <form class="form-horizontal" role="form" action="process_location_form.php" method="post">
						...
						<div class="form-group">
						  <label class="control-label  col-sm-3" for="loc_add_line1">Address :</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="loc_add_line1" name="loc_add_line1" placeholder="Address 1" required="required">
							</div>
						</div>
						<div class="form-group">
						  <label class="control-label  col-sm-3" for="loc_addd_line2"></label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="loc_add_line2" name="loc_add_line2" placeholder="Address 2" >
							</div>
						</div>
						<div class="form-group">
						  <label class="control-label  col-sm-3" for="loc_add_line3"></label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="loc_add_line3" name="loc_add_line3" placeholder="Address 3" >
							</div>
						</div>
						<div class="form-group">
						  <label class="control-label  col-sm-3" for="loc_add_line4"></label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="loc_add_line4" name="loc_add_line4" placeholder="Address 4" >
							</div>
						</div>
						...
						<div class="form-group">
						  <label class="control-label col-sm-3" for="loc_create_date">Creation Date :</label>
							<div class="col-sm-8">
								<input type="date" class="form-control" id="loc_create_date" name="loc_create_date" placeholder="dd-mm-yyyy" required="required">
							</div>
						</div>
						<div class="form-group">        
