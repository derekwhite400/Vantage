...
<head>
	...
	<body>
		<div class="row">
    <div class="col-sm-2"><div class="logo"><img src="sl01.jpg"></div></div>
					...
					<div id="formhead">Login Form </div>
					 <form class="form-horizontal" role="form" action="process_login_form.php" method="post">
						<div class="form-group">
						  <label class="control-label  col-sm-3" for="user_id">Enter User id:</label>
							<div class="col-sm-8">
								<input type="text" class="form-control" id="user_id" name="user_id" placeholder="User id" required="required">
							</div>
						</div>
						<div class="form-group">
						  <label class="control-label  col-sm-3" for="user_password">Enter Password:</label>
							<div class="col-sm-8">
